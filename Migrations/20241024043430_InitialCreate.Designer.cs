...
namespace PototoTrade.Migrations
{
    ...
    [Migration("20241024043430_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PototoTrade.Models.UserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserActivitiesLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserWallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PototoTrade.Models.BuyerItem.BuyerItems", b =>
                {
                    b.HasOne("PototoTrade.Models.UserAccount", "Buyer")
                        .WithMany("BuyerItems")
            ...
            modelBuilder.Entity("PototoTrade.Models.Notification.Notifications", b =>
                {
                    b.HasOne("PototoTrade.Models.UserAccount", "User")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserReport", b =>
                {
                    b.HasOne("PototoTrade.Models.UserAccount", "ReportedUser")
                    ...
                    b.HasOne("PototoTrade.Models.UserAccount", "ReporterUser")
            ...
            modelBuilder.Entity("PototoTrade.Models.UserWallet", b =>
                {
                    b.HasOne("PototoTrade.Models.UserAccount", "User")
                        .WithOne("UserWallet")
                        .HasForeignKey("PototoTrade.Models.UserWallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PototoTrade.Models.WalletTransaction", b =>
                {
                    b.HasOne("PototoTrade.Models.UserWallet", "Wallet")
