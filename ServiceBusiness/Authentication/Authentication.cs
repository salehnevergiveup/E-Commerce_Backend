...
namespace PototoTrade.ServiceBusiness.Authentication
{
    public class Authentication
    {
        ...
        public Authentication(IConfiguration configuration, MediaRepository mediaReposiotry, UserAccountRepository userAccountRepo, IHashing hashing, SessionRepository sessionRepo, UserDetailsRepository userDetails, DBC bC, RoleRepository roleRepository)
        {
